...
const KPICard = ({ title, value, change, changeType, icon: Icon, color = "primary", trend, subtitle }) => (
        ...
        <div className="flex-1">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className={`p-2 rounded-lg bg-gradient-to-br ${
              ...
              color === 'secondary' ? 'from-purple-500 to-purple-600' :
              color === 'success' ? 'from-emerald-500 to-emerald-600' :
              color === 'warning' ? 'from-amber-500 to-amber-600' :
...
const QuickAction = ({ title, description, icon: Icon, onClick, color = "primary", href }) => {
  const content = (
              ...
              <CardContent>
                <div className="space-y-4">
                  {recentActivities.map((activity, index) => (
                    <div key={index} className="flex items-start space-x-4 p-4 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100/50 dark:from-slate-800/50 dark:to-slate-700/30 hover:shadow-md transition-all duration-200">
              ...
              <CardContent>
                <div className="space-y-3">
                  {upcomingTasks.map((task, index) => (
                    <div key={index} className="flex items-start space-x-3 p-3 rounded-lg bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
