...
export const EditContent = () => {
  ...
  useEffect(() => {
    ...
    const mockContent = {
      ...
      author: "Admin User",
      description:
        "Complete guide for new users to get started with the platform",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ submit: "Failed to update content. Please try again." });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-400 mt-1">Update content details</p>
        </div>
      </div>
